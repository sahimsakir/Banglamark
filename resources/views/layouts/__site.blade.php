...
<body>
    ...
    <div class="header-body">
        ...
        <div class="row pt-5 pb-2">
            ...
            <div class="col-md-6 col-lg-3 mb-lg-0 vfooter">
                ...
                <ul class="list list-icons list-icons-lg ">
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="about-overview.php">Overview</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="about-vision.php">Vision and Values</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="about-founders.php">Founders Message</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="about-achievement.php">Achievement and Award</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="about-code.php">Code of Conduct</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
            ...
            <div class="col-md-6 col-lg-3 mb-lg-0 vfooter">
                ...
                <ul class="list list-icons list-icons-lg ">
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="after-sales-service.php">Service & Maintenance</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-spare-parts.php">Spare Parts</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-rental.php">Rental Service</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-center.php">Service Center</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-wearhouse.php">Wearhouse</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-training.php">Training & Knowhow</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="service-expertise.php">Technical Expertise</a></p>
                    </li>
                </ul>
    ...
    <div class="footer-copyright">
     ...
     <!-- Vendor -->
        ...
        <script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"69b476535d434a77","version":"2021.9.0","r":1,"token":"03fa3b9eb60b49789931c4694c153f9b","si":100}'></script>
