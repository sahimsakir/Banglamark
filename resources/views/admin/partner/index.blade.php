...
@section('header','Admin | Manage Partners')
@section('content')
                ...
                <div class="card-header p-2">
                   ...
                   <div class="row">
                       ...
                       <div class="col-4">
                           ...
                           <button type="button" class="modal-with-form btn btn-primary btn-sm" href="#modalForm">+ Add New Partner</button>
                       </div>
                   </div>
                   </form>
                	...
                	<table class="table table-bordered text-center">
                		<thead>
                			<tr>
                				...
                				<th class="p-1" style="width: 60%">Partner's Name</th>
                				<th class="p-1" style="width: 30%">Partner's Logo</th>
                		...
                		<tbody>
                			...
                			<tr>
                				...
                				<td class="p-1">
                					<form action="{{route('partners.destroy',$row->id)}}" method="post" onsubmit="return confirm('Are you sure, do you want to Delete?');">
                					    @csrf
                					    @method('delete')
...
<div id="modalForm" class="modal-block modal-block-primary mfp-hide">
    <section class="card">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                <label for="inputEmail4">Logo <i>(Image Size: 230px by 80px)</i></label>
